    ...
    <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
      <li className="hover:scale-95 transition-all">
        <a href="/" className="flex block py-2 px-3 md:p-0 text-white bg-blue-700 rounded-sm md:bg-transparent md:text-white-700 md:dark:text-white-500 text-sm" aria-current="page">
          <svg className="w-5 h-5 text-text dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
      ...
      <li className="hover:scale-95 transition-all">
        <a href="#" className="text-sm flex block md:p-0 text-white-900 rounded-sm md:hover:bg-transparent md:hover:text-white-700 md:dark:hover:text-white-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700" id="deletealltables">
         ...
         <span className="mx-2 text-white hover:text-red-600">Delete All table</span>
        </a>
      </li>
    </ul>
  </div>
